...
function Contact() {
  ...
  return (
    ...
    <div className='flex flex-col border-y-[1px] border-[#33323D] border-solid  py-8 gap-6 mt-[94px] lg:flex-row lg:justify-between'>
      ...
      <h2 className="text-[40px] Nova leading-[42px] font-bold mt-6 ">Contact Me</h2>
    <div className='lg:w-[635px]'>
    <div className='mt-8'>
        <h3 className='mb-2 text-[13px] font-bold sans opacity-80'>Name</h3>
        <input type="text" placeholder='Jane Appleseed' className='bg-[#33323D] text-white h-12 w-full px-4'/>
    </div>
    <div className='mt-6'>
        <h3 className='mb-2 text-[13px] font-bold sans opacity-80'>Email Address</h3>
        <input type="text" placeholder='email@example.com' className='bg-[#33323D] text-white h-12 w-full px-4'/>
    </div>
    <div className='mt-6'>
        <h3 className='mb-2 text-[13px] font-bold sans opacity-80'>Message</h3>
        <input type='text' placeholder='How can I help?' className='bg-[#33323D] text-white w-full px-4 pb-[56px] h-[96px]'/>
    </div>
    </div>
